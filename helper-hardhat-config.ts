...
export const NETWORKS_RPC_URL: iParamsPerNetwork<string> = {
  ...
  [eEthereumNetwork.bsc_testnet]: 'https://data-seed-prebsc-1-s2.binance.org:8545/',
  [eEthereumNetwork.bsc]: 'https://bsc-dataseed.binance.org/',
  // [eEthereumNetwork.avalanche_testnet]: 'https://api.avax-test.network/ext/bc/C/rpc',
  // [eEthereumNetwork.avalanche]: 'https://api.avax.network/ext/bc/C/rpc',
  // [eEthereumNetwork.fantom_testnet]: 'https://rpc.testnet.fantom.network/',
  // [eEthereumNetwork.fantom]: 'https://rpcapi.fantom.network/',
...
export const NETWORKS_DEFAULT_GAS: iParamsPerNetwork<number|string> = {
  ...
  [eEthereumNetwork.bsc_testnet]: gasPrice(10),
  [eEthereumNetwork.bsc]: gasPrice(1),
  // [eEthereumNetwork.avalanche_testnet]: gasPrice(30),
  // [eEthereumNetwork.avalanche]: gasPrice(1),
  // [eEthereumNetwork.fantom_testnet]: gasPrice(10),
  // [eEthereumNetwork.fantom]: gasPrice(1),  
